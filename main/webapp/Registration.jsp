    ...
    <section id="content">
     <div class="col-lg-6">
	  <div class="appoinment-wrap mt-5 mt-lg-0 pl-lg-5">
	   <h2 class="mb-2 title-color">Student Registration</h2>
		<br><p class="mb-4">Fill All Detail</p>
          ...
          <div class="row">
			<div class="col-lg-8">
					...
					<div class="form-group">
			   		...
			   		<div class="form-group">
	                      <input name="Mobilenumber" id="Mobilenumber" type="text" class="form-control" placeholder="Mobilenumber">
					</div>
				    <div class="form-group">
						<input name="Branch" id="Branch" type="text" class="form-control" placeholder="Branch">
					</div>
                    <div class="form-group">
						<input name="College" id="College" type="text" class="form-control" placeholder="College">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="submit" name="action" value="Register" class="btn btn-main btn-round-full">
					</div>
					</div>					          	 
         </form>
        </div>
